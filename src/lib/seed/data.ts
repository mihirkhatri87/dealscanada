...
const SPECS: SeedSpec[] = [
  ...
  {
    title: 'GoPro HERO12 Black Action Camera Bundle',
    domain: 'bestbuy.ca',
    price: 39999,
    priceWas: 54999,
    brand: 'GoPro',
  ...
  {
    title: 'Kindle Paperwhite 16GB - Ad-Supported',
    domain: 'amazon.ca',
    price: 14999,
    priceWas: 19499,
    brand: 'Amazon',
  ...
  {
    title: 'Corsair Vengeance 32GB (2x16GB) DDR5-6000 RAM',
    domain: 'newegg.ca',
    price: 12999,
    priceWas: 18999,
    brand: 'Corsair',
  ...
  {
    title: 'Paw Patrol Big Truck Pups Toy Vehicle Set',
    domain: 'toysrus.ca',
    price: 3999,
    priceWas: 5999,
    brand: 'Paw Patrol',
  ...
  {
    title: 'Ravensburger 1000 Piece Jigsaw Puzzle - Mountain Vista',
  ...
  {
    title: 'Squishmallows 16" Plush - Assorted',
    domain: 'walmart.ca',
    price: 1997,
    priceWas: 2997,
    votes: 15,
  ...
  // --- Baby and kids -------------------------------------------------------
  {
    title: 'Graco Modes Pramette Travel System Stroller',
  ...
  {
    title: 'Britax One4Life Convertible Car Seat',
  ...
  {
    title: 'Pampers Baby Dry Diapers Size 4 - 174 Count',
    domain: 'well.ca',
    price: 4499,
    priceWas: 5999,
    brand: 'Pampers',
  ...
  {
    title: "Old Navy Girls' Frost-Free Puffer Jacket",
    domain: 'oldnavy.ca',
    price: 2999,
    priceWas: 7999,
    brand: 'Old Navy',
  ...
  {
    title: "Old Navy Boys' Sherpa-Lined Hoodie",
    domain: 'oldnavy.ca',
    price: 2199,
    priceWas: 4499,
    brand: 'Old Navy',
  ...
  {
    title: "Gap Men's Vintage Soft Arch Logo Hoodie",
    domain: 'gapcanada.ca',
    price: 3499,
    priceWas: 6995,
    brand: 'Gap',
  ...
  {
    title: 'Banana Republic Merino Wool Crew Sweater',
  ...
  {
    title: "Athleta Women's Ultimate Stash Pocket 7/8 Tight",
    domain: 'athleta.ca',
    price: 4999,
    priceWas: 10900,
    brand: 'Athleta',
  ...
  {
    title: "Gap Factory Women's Cropped Denim Jacket",
  ...
  {
    title: "Reitmans Women's Slim Leg Comfort Pant",
    domain: 'reitmans.com',
    price: 2499,
    priceWas: 5990,
    brand: 'Reitmans',
  ...
  {
    title: 'RW&CO. Tailored Blazer - Navy',
    domain: 'rw-co.com',
    price: 6999,
    priceWas: 14900,
    brand: 'RW&CO.',
  ...
  {
    title: 'Penningtons Plus Size Winter Parka',
  ...
  {
    title: 'Roots Original Kanga Sweatpant',
    domain: 'roots.com',
    price: 4999,
    priceWas: 8800,
    brand: 'Roots',
  ...
  {
    title: 'Blundstone 550 Chelsea Boots - Walnut',
    domain: 'softmoc.com',
    price: 18999,
    priceWas: 24995,
    brand: 'Blundstone',
  ...
  {
    title: 'Columbia Powder Lite Insulated Jacket',
  ...
  {
    title: 'Uniqlo Ultra Light Down Vest',
    domain: 'uniqlo.com',
    price: 3990,
    priceWas: 6990,
    brand: 'Uniqlo',
  ...
  {
    title: 'Ninja Foodi 6-in-1 8QT 2-Basket Air Fryer',
  ...
  {
    title: 'Instant Pot Duo Plus 6QT Pressure Cooker',
    domain: 'walmart.ca',
    price: 8999,
    priceWas: 14999,
    brand: 'Instant Pot',
  ...
  {
    title: 'KitchenAid Artisan 5QT Stand Mixer - Empire Red',
    domain: 'thebay.com',
    price: 39999,
    priceWas: 64999,
    brand: 'KitchenAid',
  ...
  {
    title: 'Dyson V15 Detect Cordless Stick Vacuum',
    domain: 'costco.ca',
    price: 59999,
    priceWas: 89999,
    brand: 'Dyson',
  ...
  {
    title: 'LG WashTower Stacked Washer and Dryer',
    domain: 'leons.ca',
    price: 219999,
    priceWas: 299999,
    brand: 'LG',
  ...
  {
    title: 'Endy Original Mattress - Queen',
    domain: 'wayfair.ca',
    price: 89500,
    priceWas: 122500,
    brand: 'Endy',
  ...
  {
    title: 'Weber Spirit II E-310 3-Burner Propane BBQ',
    domain: 'canadiantire.ca',
    price: 64999,
    priceWas: 79999,
    brand: 'Weber',
  ...
  {
    title: 'Philips Hue White and Colour Starter Kit',
    domain: 'bestbuy.ca',
    price: 17999,
    priceWas: 25999,
    brand: 'Philips',
  ...
  // --- Tools and auto ------------------------------------------------------
  {
    title: 'DEWALT 20V MAX Cordless Drill and Impact Driver Combo Kit',
    domain: 'homedepot.ca',
    price: 24999,
    priceWas: 39999,
    brand: 'DEWALT',
  ...
  {
    title: 'Mastercraft 200-Piece Socket Set',
    domain: 'canadiantire.ca',
    price: 8999,
    priceWas: 19999,
    brand: 'Mastercraft',
  ...
  {
    title: 'Michelin X-Ice Snow Winter Tire 205/55R16',
    domain: 'canadiantire.ca',
    price: 15999,
    priceWas: 21999,
    brand: 'Michelin',
  ...
  // --- Sports and outdoors -------------------------------------------------
  {
    title: 'MEC Volt 20L Hiking Backpack',
    domain: 'mec.ca',
    price: 5999,
    priceWas: 9500,
    brand: 'MEC',
  ...
  {
    title: 'Bauer Vapor X3.7 Senior Hockey Skates',
    domain: 'sportchek.ca',
    price: 24999,
    priceWas: 39999,
    brand: 'Bauer',
  ...
  // --- Grocery -------------------------------------------------------------
  {
    title: 'Lavazza Super Crema Whole Bean Coffee 1kg',
    domain: 'amazon.ca',
    price: 2499,
    priceWas: 3499,
    brand: 'Lavazza',
  ...
  {
    title: 'Kirkland Signature Granola Bars 64 Pack',
    domain: 'costco.ca',
    price: 1799,
    priceWas: 2299,
    brand: 'Kirkland',
  ...
  {
    title: 'Sitewide: Extra 40% off all clearance',
    domain: 'gapcanada.ca',
    price: 0,
    priceWas: null,
    coupon: 'EXTRA40',
    ...
    hoursAgo: 2,
    image: null,
    description: 'Storewide promotion, discount applied at checkout.',
  },
  {
    title: 'Mystery Box Electronics Bundle',
    domain: 'newegg.ca',
    price: 4999,
    priceWas: null,
    votes: 5,
  ...
  {
    title: 'Sold Out: Nintendo Switch Pro Controller',
    domain: 'bestbuy.ca',
    price: 6999,
    priceWas: 8999,
    brand: 'Nintendo',
  ...
  {
    title: 'Ends Tonight: Roots Sweatshirt Doorcrasher',
    domain: 'roots.com',
    price: 2999,
    priceWas: 7800,
    brand: 'Roots',
  ...
  {
    title: 'In-store clearance: Mastercraft Cordless Drill',
    domain: 'canadiantire.ca',
    price: 4999,
    priceWas: 12999,
    storeChain: 'canadian-tire',
    votes: 0,
    hoursAgo: 5,
  },
  {
    title: 'In-store clearance: Woods Winter Sleeping Bag',
    domain: 'canadiantire.ca',
    price: 2999,
    priceWas: 8999,
    storeChain: 'canadian-tire',
  ...
  {
    title: 'Red-tag clearance: NordicTrack Exercise Bike',
    domain: 'canadiantire.ca',
    price: 29999,
    priceWas: 79999,
    storeChain: 'canadian-tire',
  ...
  {
    title: 'In-store clearance: Bauer Youth Hockey Helmet',
    domain: 'sportchek.ca',
    price: 3499,
    priceWas: 8999,
    storeChain: 'sportchek',
    votes: 0,
    hoursAgo: 14,
  },
  {
    title: 'In-store clearance: Under Armour Training Shorts',
    domain: 'sportchek.ca',
    price: 1499,
    priceWas: 4499,
    storeChain: 'sportchek',
  ...
  {
    title: 'Clearance: Instant Pot Air Fryer Lid',
    domain: 'walmart.ca',
    price: 3900,
    priceWas: 9900,
    storeChain: 'walmart',
  ...
  {
    title: 'Clearance: Graco Baby Swing (floor model)',
    domain: 'walmart.ca',
    price: 5900,
    priceWas: 14900,
    storeChain: 'walmart',
...
function applyVerification(deals: DealInput[], priceHistory: SeedPricePoint[], now: Date): void {
  ...
  for (const deal of deals) {
    ...
    const historyDays =
      history.length > 0
        ? Math.max(
            ...history.map((point) => (now.getTime() - Date.parse(point.observedAt)) / 86_400_000),
          )
        : 0;
