...
const FSA_PREFIX: Record<string, { lat: number; lng: number; label: string }> = {
  ...
  L5: { lat: 43.589, lng: -79.6441, label: 'Mississauga' },
  ...
  H2: { lat: 45.53, lng: -73.59, label: 'Montréal' },
  H3: { lat: 45.4972, lng: -73.5794, label: 'Montréal' },
  H4: { lat: 45.479, lng: -73.644, label: 'Montréal' },
  H7: { lat: 45.6066, lng: -73.7124, label: 'Laval' },
  H9: { lat: 45.46, lng: -73.83, label: 'West Island' },
  J4: { lat: 45.47, lng: -73.45, label: 'Longueuil' },
  G1: { lat: 46.8139, lng: -71.208, label: 'Québec City' },

  // Western Canada
  V5: { lat: 49.2276, lng: -123.0076, label: 'Vancouver' },
  V6: { lat: 49.265, lng: -123.13, label: 'Vancouver' },
  V7: { lat: 49.32, lng: -123.07, label: 'North Vancouver' },
  V3: { lat: 49.2057, lng: -122.911, label: 'Surrey' },
  V8: { lat: 48.4284, lng: -123.3656, label: 'Victoria' },
  T2: { lat: 51.0447, lng: -114.0719, label: 'Calgary' },
  T3: { lat: 51.1, lng: -114.18, label: 'Calgary' },
  T5: { lat: 53.5461, lng: -113.4938, label: 'Edmonton' },
  T6: { lat: 53.47, lng: -113.49, label: 'Edmonton' },
  S7: { lat: 52.1332, lng: -106.67, label: 'Saskatoon' },
  S4: { lat: 50.4452, lng: -104.6189, label: 'Regina' },
  R3: { lat: 49.8951, lng: -97.1384, label: 'Winnipeg' },
  R2: { lat: 49.92, lng: -97.14, label: 'Winnipeg' },
  ...
  X1: { lat: 62.454, lng: -114.3718, label: 'Yellowknife' },
...
const PROVINCE_BY_LETTER: Record<string, { lat: number; lng: number; label: string }> = {
  ...
  G: { lat: 46.8139, lng: -71.208, label: 'Eastern Québec' },
  H: { lat: 45.5019, lng: -73.5674, label: 'Montréal' },
  J: { lat: 45.4, lng: -73.2, label: 'Western Québec' },
  K: { lat: 45.4215, lng: -75.6972, label: 'Eastern Ontario' },
  L: { lat: 43.6, lng: -79.6, label: 'Central Ontario' },
  M: { lat: 43.6532, lng: -79.3832, label: 'Toronto' },
  N: { lat: 43.0, lng: -81.0, label: 'Southwestern Ontario' },
  P: { lat: 46.4917, lng: -80.993, label: 'Northern Ontario' },
  R: { lat: 49.8951, lng: -97.1384, label: 'Manitoba' },
  S: { lat: 52.1332, lng: -106.67, label: 'Saskatchewan' },
  T: { lat: 51.0447, lng: -114.0719, label: 'Alberta' },
  V: { lat: 49.2827, lng: -123.1207, label: 'British Columbia' },
  X: { lat: 62.454, lng: -114.3718, label: 'Northwest Territories and Nunavut' },
...
export const KNOWN_CITIES: Array<{ name: string; lat: number; lng: number }> = [
  ...
  { name: 'Québec City', lat: 46.8139, lng: -71.208 },
...
export function coordinatesForCity(input: string): Coordinates | null {
  const needle = input.trim().toLowerCase().normalize('NFD').replace(/[̀-ͯ]/g, '');
  ...
  return match ? { lat: match.lat, lng: match.lng, precision: 'city', label: match.name } : null;
}
